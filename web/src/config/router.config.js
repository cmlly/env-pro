...
export const asyncRouterMap = [
  {
    ...
    children: [
      ...
      // 活动实践管理
      {
        ...
        name: 'Active',
        component: RouteView,
        meta: { title: '活动管理', icon: 'profile', permission: ['table'] },
        children: [
          {
            path: '/active/create',
            name: 'CreateActive',
            component: () => import('@/views/active/CreateActive'),
            meta: { title: '新建活动', keepAlive: true, permission: ['table'] }
          },
          {
            path: '/active/list',
            name: 'ActiveList',
            component: () => import('@/views/active/ActiveList'),
            meta: { title: '活动列表', keepAlive: true, permission: ['table'] }
          },
          {
            path: '/active/edit/:id',
            name: 'EditActive',
            component: () => import('@/views/active/EditActive'),
            meta: { title: '编辑活动', keepAlive: true, permission: ['table'] },
            hidden: true
          }
        ]
      },
      ...
      // 论坛管理
      {
        ...
        name: 'Forum',
        component: RouteView,
        meta: { title: '论坛管理', icon: 'slack', permission: ['table'] },
        children: [
          {
            path: '/forum/create',
            name: 'CreateForum',
            component: () => import('@/views/forum/CreateForum'),
            meta: { title: '新建帖子', keepAlive: true, permission: ['table'] }
          },
          {
            path: '/forum/list',
            name: 'ForumList',
            component: () => import('@/views/forum/ForumList'),
            meta: { title: '帖子列表', keepAlive: true, permission: ['table'] }
          },
          {
            path: '/forum/edit/:id',
            name: 'EditForum',
            component: () => import('@/views/forum/EditForum'),
            meta: { title: '编辑帖子', keepAlive: true, permission: ['table'] },
            hidden: true
          }
        ]
      }
    ...
    children: [
      {
        ...
        children: [
          ...
          },
          {
            ...
            name: 'courseDetail',
            component: () => import('@/views/user/course/CourseDetail')
          },
          {
            path: 'forumDetail/:id',
            name: 'forumDetail',
            component: () => import('@/views/user/forum/ForumDetail')
          },
          {
            path: 'news',
            name: 'news',
